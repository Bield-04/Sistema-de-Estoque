...
def atualizar_lista_produtos():
    ...
    for produto in estoque.produtos:
        listbox_produtos.insert(END, f"{produto.nome} - Preço: R${produto.preco:.2f} - Quantidade: {produto.quantidade}")

# NOVA FUNÇÃO: REALIZAR A VENDA
def realizar_venda():
    try:
        # 1. Pega o índice do produto selecionado na Listbox
        ...
        indice = selecao[0]
        # Pega o objeto produto direto da lista do estoque usando o índice
        ...
        if qtd_venda <= produto_selecionado.quantidade:
            ...
            # (Opcional) Cria o objeto Venda se a sua classe tiver essa estrutura
...
# Label para mostrar se a venda deu certo ou deu erro na tela
